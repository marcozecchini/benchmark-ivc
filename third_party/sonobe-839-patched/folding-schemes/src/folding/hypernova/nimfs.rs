...
impl<C: Curve, T: Transcript<C::ScalarField>> NIMFS<C, T> {
    ...
    > {
        ...
        if std::env::var("HN_PROFILE").is_ok() {
            eprintln!("[hn-profile]   nimfs/compute_g: {:?}", _prof_t.elapsed());
        }
        ...
        if std::env::var("HN_PROFILE").is_ok() {
            eprintln!("[hn-profile]   nimfs/sumcheck_prove: {:?}", _prof_t.elapsed());
        }
        ...
        if std::env::var("HN_PROFILE").is_ok() {
            eprintln!("[hn-profile]   nimfs/sigmas_thetas: {:?}", _prof_t.elapsed());
        }
        ...
        if std::env::var("HN_PROFILE").is_ok() {
            eprintln!("[hn-profile]   nimfs/fold_witness: {:?}", _prof_t.elapsed());
        }
